...
%Institution macros, because laziness
...
\begin{tabular}{rp{.75\linewidth}}
    \textsc{Email:}     & \href{mailto:matt@critchlow.xyz}{matt@critchlow.xyz}\\
    \textsc{www:}&\href{https://critchlow.xyz}{critchlow.xyz}
\end{tabular}
\end{minipage}
\begin{minipage}[t]{.5\linewidth}
\begin{tabular}{rl}
\textsc{Github:} & \href{http://github.com/mcritchlow}{mcritchlow}\\
\textsc{Public Key:}&\href{http://pgp.mit.edu/pks/lookup?op=get&search=0x5B86D84AB60CAB15}{5B86D84AB60CAB15}
\end{tabular}
\end{minipage}
